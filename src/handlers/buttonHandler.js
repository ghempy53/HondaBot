...
module.exports = async (client, interaction) => {
    ...
    else if (Config.battlemetrics.enabled && interaction.customId === 'DisplayInformationBattlemetricsAllOnlinePlayers') {
    ...
    else if (Config.battlemetrics.enabled && interaction.customId === 'BattlemetricsServerNameChanges') {
    ...
    else if (Config.battlemetrics.enabled && interaction.customId === 'BattlemetricsTrackerNameChanges') {
    ...
    else if (Config.battlemetrics.enabled && interaction.customId === 'BattlemetricsGlobalNameChanges') {
    ...
    else if (Config.battlemetrics.enabled && interaction.customId === 'BattlemetricsGlobalLogin') {
    ...
    else if (Config.battlemetrics.enabled && interaction.customId === 'BattlemetricsGlobalLogout') {
    ...
    else if (Config.battlemetrics.enabled && interaction.customId.startsWith('ServerEdit')) {
    ...
    else if (Config.battlemetrics.enabled && interaction.customId.startsWith('CreateTracker')) {
    ...
    else if (Config.battlemetrics.enabled && interaction.customId.startsWith('TrackerEveryone')) {
    ...
    else if (Config.battlemetrics.enabled && interaction.customId.startsWith('TrackerUpdate')) {
    ...
    else if (Config.battlemetrics.enabled && interaction.customId.startsWith('TrackerEdit')) {
    ...
    else if (Config.battlemetrics.enabled && interaction.customId.startsWith('TrackerDelete')) {
    ...
    else if (Config.battlemetrics.enabled && interaction.customId.startsWith('TrackerAddPlayer')) {
    ...
    else if (Config.battlemetrics.enabled && interaction.customId.startsWith('TrackerRemovePlayer')) {
    ...
    else if (Config.battlemetrics.enabled && interaction.customId.startsWith('TrackerInGame')) {
